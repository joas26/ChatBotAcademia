...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    }else if(viewType == QRCODE){

    itemView = LayoutInflater.from(parent.getContext())
            .inflate(R.layout.chat_item_qrcode, parent, false);
  }else {
      // WatBot message
      itemView = LayoutInflater.from(parent.getContext())
  ...
  public int getItemViewType(int position) {
    ...
    if (message.getId() != null && message.getId().equals("50")) {
      return QRCODE;
    }
  ...
  public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView message;
    ImageView equipamento;

    public ViewHolder(View view) {
      super(view);
      message = (TextView) itemView.findViewById(R.id.message);
      equipamento = (ImageView) itemView.findViewById(R.id.ImagemEquipamento);
